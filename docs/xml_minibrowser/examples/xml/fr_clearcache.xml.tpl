...
<SnomIPPhoneBatch xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <!-- setcache callback not working, but setcache fragment and flush are working -->
        ...
        <SoftKeyItem>
            <Name>*</Name>
            <Url>${TPL_ROOT_URL}/xml_minibrowser/examples/xml/fr_clearcache.xml#sub=*[@id="page1"]&amp;setcache:fkey_label[0]=weather</Url>
        </SoftKeyItem>
    ...
    <SnomIPPhoneText id="page1">
        ...
        <SoftKeyItem>
            <Name>*</Name>
            <Url>${TPL_ROOT_URL}/xml_minibrowser/examples/xml/fr_clearcache.xml#sub=*[@id="page2"]&amp;clearcache</Url>
        </SoftKeyItem>
        <Text>set:fkey_label0:$(set:fkey_label0)<br />
            setcache:fkey_label0:$(setcache:fkey_label0)<br/>
    ...
    <SnomIPPhoneText id="page2">
        ...
        <SoftKeyItem>
            <Name>*</Name>
            <Url>${TPL_ROOT_URL}/xml_minibrowser/examples/xml/fr_clearcache.xml#sub=*[@id="page3"]&amp;flush</Url>
        </SoftKeyItem>
        <Text>set:fkey_label0:$(set:fkey_label0)<br />
            setcache:fkey_label0:$(setcache:fkey_label0)<br/>
