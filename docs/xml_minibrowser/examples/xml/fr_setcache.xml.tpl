...
<SnomIPPhoneBatch xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="../minibrowser_test.xsd">
    <SnomIPPhoneText id="page0">
        ...
        <SoftKeyItem>
            <Name>*</Name>
            <Url>${TPL_ROOT_URL}/xml_minibrowser/examples/xml/fr_setcache.xml#sub=*[@id="page1"]&amp;setcache:fkey_label0=weather</Url>
        </SoftKeyItem>
    ...
    <SnomIPPhoneText id="page1">
        ...
        <SoftKeyItem>
            <Name>*</Name>
            <Url>${TPL_ROOT_URL}/xml_minibrowser/examples/xml/fr_setcache.xml#sub=*[@id="page2"]&amp;flush</Url>
        </SoftKeyItem>
        <Text>set:fkey_label0:$(set:fkey_label0)<br />
            setcache:fkey_label0:$(setcache:fkey_label0)<br/>
    ...
    <SnomIPPhoneText id="page2">
        ...
        <SoftKeyItem>
            <Name>*</Name>
            <Url>${TPL_ROOT_URL}/xml_minibrowser/examples/xml/fr_setcache.xml#sub=*[@id="page3"]</Url>
        </SoftKeyItem>
        <Text>set:fkey_label0:$(set:fkey_label0)<br />
            setcache:fkey_label0:$(setcache:fkey_label0)<br/>
